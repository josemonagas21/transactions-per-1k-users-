-- Sample data
CREATE TABLE `nyt-bigquery-beta-workspace.jose_data.weekly-transactions`
...
FrOM
  ...
  where date between '2021-01-04' and '2021-12-26'
group by 1),
...
users as (
  SELECT 
    ...
    WHERE
        DATE(_pt) between '2021-01-04' and '2021-12-26'
